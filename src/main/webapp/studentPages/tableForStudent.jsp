...
<a href="${pageContext.request.contextPath}/UserInfo" onclick=""><fmt:message key="go.back"/></a>
<p style="text-align:right"><a href="${pageContext.request.contextPath}/Logout"> <fmt:message key="sign.out"/> </a></p>
<form action="${pageContext.request.contextPath}/Student/CourseListForStudent" method="POST">
    <c:choose>
        <c:when test="${courseMap.size() > 0}">
            <table>
                ...
                <p style="text-align: right">
                    <a href="${pageContext.request.contextPath}/Student/Certificate">Download certificate</a>
                </p>
                <tbody>
                <c:forEach var="entry" items="${courseMap.entrySet()}">
                    <tr>
                        ...
                        <td data-label="<fmt:message key="course.mark"/>">${entry.getValue()}</td>
                    </tr>
                </c:forEach>
                </tbody>
